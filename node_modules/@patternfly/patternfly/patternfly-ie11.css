...
.pf-c-app-launcher__menu-item-external-icon {
  ...
  color: #004080;
  opacity: 0;
  transform: translateY(pf-size-prem(-1px)); }
...
.pf-c-avatar {
  width: pf-size-prem(36px);
  height: pf-size-prem(36px);
  border-radius: 30em; }
...
.pf-c-popover {
  position: relative;
  min-width: calc(2rem + pf-size-prem(100px));
  max-width: calc(2rem + pf-size-prem(300px));
  box-shadow: 0 0.0625rem 0.0625rem 0rem rgba(3, 3, 3, 0.05), 0 0.25rem 0.5rem 0.25rem rgba(3, 3, 3, 0.06); }
...
.pf-c-popover__content {
  ...
  .pf-c-popover__content > .pf-c-button {
    position: absolute;
    top: calc(2rem - 0.375rem + pf-size-prem(1px));
    right: 1rem; }
    .pf-c-popover__content > .pf-c-button + * {
      padding-right: 2rem; }
...
.pf-c-switch {
  ...
  .pf-c-switch .pf-c-switch__input {
    ...
    .pf-c-switch .pf-c-switch__input:checked ~ .pf-c-switch__toggle {
      ...
      .pf-c-switch .pf-c-switch__input:checked ~ .pf-c-switch__toggle::before {
        transform: translateX(calc(100% + pf-size-prem(2px))); }
  ...
  .pf-c-switch .pf-c-switch__toggle {
    position: relative;
    display: inline-block;
    width: calc(calc(1rem * 1.5) + pf-size-prem(2px) + calc(1rem - pf-size-prem(2px)));
    height: calc(1rem * 1.5);
    background-color: #d2d2d2;
    border-radius: calc(1rem * 1.5); }
    .pf-c-switch .pf-c-switch__toggle::before {
      position: absolute;
      top: calc((calc(1rem * 1.5) - calc(1rem - pf-size-prem(2px))) / 2);
      left: calc((calc(1rem * 1.5) - calc(1rem - pf-size-prem(2px))) / 2);
      display: block;
      width: calc(1rem - pf-size-prem(2px));
      height: calc(1rem - pf-size-prem(2px));
      content: "";
      background-color: #fff;
      border-radius: 30em;
      box-shadow: 0 0.0625rem 0.0625rem 0rem rgba(3, 3, 3, 0.05), 0 0.25rem 0.5rem 0.25rem rgba(3, 3, 3, 0.06);

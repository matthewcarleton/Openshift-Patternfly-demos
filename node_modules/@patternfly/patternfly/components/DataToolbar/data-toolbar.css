...
.pf-c-data-toolbar .pf-m-reveal.pf-m-toggle-group {
  --pf-c-data-toolbar--spacer: var(--pf-c-data-toolbar__group--m-toggle-group--m-reveal--spacer); }
  .pf-c-data-toolbar .pf-m-reveal.pf-m-toggle-group:last-child {
    --pf-c-data-toolbar--spacer: 0; }
...
@media (min-width: 768px) {
  ...
  .pf-c-data-toolbar .pf-m-visible-on-md {
    display: flex;
    visibility: visible; }
  .pf-c-data-toolbar .pf-m-reveal-on-md.pf-m-toggle-group {
    --pf-c-data-toolbar--spacer: var(--pf-c-data-toolbar__group--m-toggle-group--m-reveal--spacer); }
    .pf-c-data-toolbar .pf-m-reveal-on-md.pf-m-toggle-group:last-child {
      --pf-c-data-toolbar--spacer: 0; }
...
@media (min-width: 992px) {
  ...
  .pf-c-data-toolbar .pf-m-visible-on-lg {
    display: flex;
    visibility: visible; }
  .pf-c-data-toolbar .pf-m-reveal-on-lg.pf-m-toggle-group {
    --pf-c-data-toolbar--spacer: var(--pf-c-data-toolbar__group--m-toggle-group--m-reveal--spacer); }
    .pf-c-data-toolbar .pf-m-reveal-on-lg.pf-m-toggle-group:last-child {
      --pf-c-data-toolbar--spacer: 0; }
...
@media (min-width: 1200px) {
  ...
  .pf-c-data-toolbar .pf-m-visible-on-xl {
    display: flex;
    visibility: visible; }
  .pf-c-data-toolbar .pf-m-reveal-on-xl.pf-m-toggle-group {
    --pf-c-data-toolbar--spacer: var(--pf-c-data-toolbar__group--m-toggle-group--m-reveal--spacer); }
    .pf-c-data-toolbar .pf-m-reveal-on-xl.pf-m-toggle-group:last-child {
      --pf-c-data-toolbar--spacer: 0; }
...
@media (min-width: 1450px) {
  ...
  .pf-c-data-toolbar .pf-m-visible-on-2xl {
    display: flex;
    visibility: visible; }
  .pf-c-data-toolbar .pf-m-reveal-on-2xl.pf-m-toggle-group {
    --pf-c-data-toolbar--spacer: var(--pf-c-data-toolbar__group--m-toggle-group--m-reveal--spacer); }
    .pf-c-data-toolbar .pf-m-reveal-on-2xl.pf-m-toggle-group:last-child {
      --pf-c-data-toolbar--spacer: 0; }
